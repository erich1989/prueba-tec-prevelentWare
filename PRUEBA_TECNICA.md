...
1. Sistema de gestión de ingresos y gastos (disponible para todos los roles)
2. Gestión de usuarios (solo para administradores)
3. Reportes (solo para administradores)
...
- Utilizar **Better Auth** con **GitHub** como proveedor de autenticación y **Prisma** como adaptador para la autenticación por sesiones de base de datos.
...
**Despliegue:** Desplegar el proyecto en Vercel.
...
- **Funcionalidad:** Cumplimiento de todos los requisitos funcionales. Correcta implementación del CRUD para ingresos, egresos y usuarios. Generación y descarga de reportes en formato CSV.
- **Calidad del Código:** Calidad y claridad del código. Uso adecuado de las mejores prácticas de desarrollo. Estructura del proyecto. Documentación completa de la API con OpenAPI/Swagger.
- **Diseño y UX:** Usabilidad de la interfaz. Implementación de un diseño atractivo.
- **Pruebas y Documentación:** Cobertura de pruebas unitarias. Calidad de los comentarios dentro del proyecto.
- **Seguridad:** Implementación efectiva de control de acceso basado en roles (RBAC). Protección adecuada de los datos sensibles.
...
- El candidato debe compartir el acceso al repositorio de GitHub y el `.env` a los correos:
